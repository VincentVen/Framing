 ...
 * @author none
 */
class TEBHallSceneModule extends how.module.SceneModule {
    ...
    private initParam() {
        how.ComponentUtils.init(false, "ld.AlertSkin", "ld.DialogSkin", "public.BannerSkin", "TEBHallSceneNoticeSkin",
            "public.LoaddingSkin", "TEBGameSceneNoticeSkin", "ld_settingWindowSkin");//初始化通用组件
    }
    private initUI() {
