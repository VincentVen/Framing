 ...
 * @author none
 */
class LDHallSceneView extends how.module.Scene {
    public static AllowReportChildren: Array<any> = ["LDGameItem"];
    //ui相关
    private userName: eui.Label;//姓名
    private userCoin: eui.Label;//金币
    ...
    public updateAvatar(): void {
        this.header.source = AppData.getInstance().userData.gender == 1 ? "ld_man_png" : "ld_woman_png";
    }
    //更新名字
