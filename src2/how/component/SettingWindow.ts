module how {
    export class SettingWindow extends how.module.Window {
        ...
        public static initSkin(skinName: any) {
            this.skinName = skinName;
        }
        public static show() {
            if (!this.skinName) {
                warn("SettingWindow弹窗未初始化，将不会被显示，请先调用how.SettingWindow.init()。");
            }
            var settingWindow: how.SettingWindow = new how.SettingWindow();
            Application.addWindow(settingWindow, true, true, true);
        }
    }
}
